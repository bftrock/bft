...
<?php get_nav(); ?>
	...
	<div id="content">
		<h2>Summary</h2>
		<p>
			An experienced engineering manager with expertise in renewable energy, resource 
			assessment for wind and solar energy, wind turbine design, hybrid power system design, 
			controls design and software development. Capable of providing strong technical 
			leadership to cross-functional groups and developing innovative ideas into successful 
			outcomes. Demonstrated ability to lead technically complex product development programs 
			to success.
		</p>
